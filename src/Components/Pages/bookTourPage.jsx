    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 pt-16 sm:pt-20 md:pt-24 pb-12 sm:pb-16 px-4 sm:px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-6 sm:mb-8 md:mb-10 lg:mb-12">
          ...
          <span className="inline-block text-brand-yellow text-[7px] sm:text-[8px] md:text-[9px] lg:text-[10px] font-black tracking-[0.3em] sm:tracking-[0.4em] uppercase mb-2 sm:mb-3 px-3 py-1 bg-white rounded-full shadow-sm">
            Schedule a Visit
          </span>
          ...
          <div className="mb-6 sm:mb-8 bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-300">
            ...
            <div className="p-4 sm:p-6">
              <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6">
                {/* Property Image */}
                <div className="w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 lg:w-32 lg:h-32 rounded-xl overflow-hidden flex-shrink-0 shadow-md">
                  <img
