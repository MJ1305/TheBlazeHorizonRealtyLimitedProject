...
const Listing = () => {
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      {/* Hero Header */}
      <div className="bg-gradient-to-br from-[#03302b] to-[#044b44] pt-20 sm:pt-24 md:pt-28 lg:pt-32 pb-12 sm:pb-16 md:pb-20 px-4 sm:px-6 text-center relative overflow-hidden">
        ...
        <div className="relative z-10">
          {/* <span className="inline-block text-brand-yellow text-[8px] sm:text-[9px] md:text-[10px] font-black tracking-[0.3em] sm:tracking-[0.4em] uppercase mb-3 sm:mb-4 px-3 py-1 bg-white/10 rounded-full backdrop-blur-sm">
            Available Assets
          </span> */}
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white mt-4 sm:mt-6 px-2">
            Property Portfolio
          </h1>
          <p className="text-gray-300 mt-3 sm:mt-4 max-w-2xl mx-auto text-sm sm:text-base px-4">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 md:py-12 lg:py-16">
        ...
        <div className="relative mb-4 sm:mb-6">
          <div className="relative">
            <svg className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 sm:w-5 sm:h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <input
              ...
              className="w-full pl-11 sm:pl-12 pr-4 py-3 sm:py-4 border border-gray-200 rounded-xl sm:rounded-2xl text-sm sm:text-base bg-white shadow-sm focus:outline-none focus:ring-2 focus:ring-[#fa8e12] focus:border-transparent transition-all"
            />
          </div>
            ...
            <div className="absolute top-full left-0 right-0 mt-2 bg-white border border-gray-200 rounded-xl shadow-xl z-50 max-h-64 overflow-y-auto">
              {suggestions.map((item) => (
                <div
                  ...
                  className="p-3 sm:p-4 hover:bg-gray-50 cursor-pointer transition-colors border-b border-gray-100 last:border-0 group"
                >
                  <p className="font-bold text-sm sm:text-base text-[#03302b] group-hover:text-[#fa8e12] transition-colors">
                    {item.title}
                  </p>
          ...
          >
            ...
            <div className="flex items-center gap-2">
              {(selectedType !== "all" || selectedBedrooms !== "all" || itemsPerPage !== 6) && (
                <span className="w-2 h-2 bg-[#fa8e12] rounded-full"></span>
              )}
        ...
        <div className={`${showFilters ? 'block' : 'hidden'} lg:block transition-all duration-300 mb-6 sm:mb-8`}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-4">
              <div>
                ...
                <select
                  ...
                  className="w-full p-2.5 sm:p-3 border border-gray-200 rounded-lg text-sm bg-white focus:outline-none focus:ring-2 focus:ring-[#fa8e12]"
                >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              ...
              <div className="flex items-end">
                <button
                  ...
                  className="w-full sm:w-auto px-4 py-2.5 text-sm text-gray-600 hover:text-[#fa8e12] transition-colors border border-gray-200 rounded-lg hover:border-[#fa8e12]"
                >
                  Clear All Filters
                </button>
              </div>
        ...
        <div className="flex flex-wrap gap-2 sm:gap-3 mb-6 sm:mb-8">
          {[
            ...
            <button
              ...
              className={`flex items-center gap-1.5 sm:gap-2 px-4 sm:px-6 py-2 sm:py-2.5 rounded-full font-black text-xs sm:text-sm transition-all ${
        ...
        {compareList.length > 0 && (
          <div className="mb-6 p-3 sm:p-4 bg-gradient-to-r from-[#fa8e12]/10 to-transparent rounded-xl border border-[#fa8e12]/20 flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4">
            <div className="flex items-center gap-2">
              <svg className="w-5 h-5 text-[#fa8e12]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
              <p className="font-bold text-sm sm:text-base text-[#03302b]">
                {compareList.length} property{compareList.length !== 1 ? 's' : ''} selected for comparison
              </p>
            </div>
            <button
              onClick={() => navigate("/compare", { state: compareList })}
              className="bg-[#fa8e12] text-white px-5 sm:px-6 py-2 rounded-lg font-bold text-sm hover:scale-105 transition-all duration-300 w-full sm:w-auto shadow-md"
            >
              Compare Now →
            </button>
          </div>
        ...
        {/* Properties Grid */}
        {searchedProperties.length === 0 ? (
          <div className="text-center py-12 sm:py-16 md:py-20 bg-white rounded-2xl shadow-sm">
            ...
            <button
              onClick={clearAllFilters}
              className="inline-flex items-center gap-2 text-[#fa8e12] text-sm font-semibold hover:underline"
            >
              Clear all filters
              ...
              {paginatedProperties.map((property) => (
                <div key={property.slug} className="relative group">
                  ...
                  <button
                    ...
                    className={`absolute top-3 right-3 z-20 text-[10px] sm:text-xs font-semibold px-2.5 sm:px-3 py-1.5 rounded-lg transition-all backdrop-blur-sm ${
